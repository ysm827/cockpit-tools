...
#[tauri::command]
pub async fn workbuddy_get_instance_defaults() -> Result<InstanceDefaults, String> {
    workbuddy_call_async("instance.getDefaults", json!({})).await
}

#[tauri::command]
pub async fn workbuddy_list_instances() -> Result<Vec<InstanceProfileView>, String> {
    workbuddy_call_async("instance.list", json!({})).await
}
...
pub async fn workbuddy_delete_instance(instance_id: String) -> Result<(), String> {
    workbuddy_call_async("instance.delete", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn workbuddy_start_instance(instance_id: String) -> Result<InstanceProfileView, String> {
    workbuddy_call_async("instance.start", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn workbuddy_stop_instance(instance_id: String) -> Result<InstanceProfileView, String> {
    workbuddy_call_async("instance.stop", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn workbuddy_open_instance_window(instance_id: String) -> Result<(), String> {
    workbuddy_call("instance.openWindow", json!({ "instanceId": instance_id }))
}

#[tauri::command]
pub async fn workbuddy_close_all_instances() -> Result<(), String> {
    workbuddy_call_async("instance.closeAll", json!({})).await
}
