...
#[tauri::command]
pub async fn codebuddy_get_instance_defaults() -> Result<InstanceDefaults, String> {
    codebuddy_call_async("instance.getDefaults", json!({})).await
}

#[tauri::command]
pub async fn codebuddy_list_instances() -> Result<Vec<InstanceProfileView>, String> {
    codebuddy_call_async("instance.list", json!({})).await
}
...
pub async fn codebuddy_delete_instance(instance_id: String) -> Result<(), String> {
    codebuddy_call_async("instance.delete", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn codebuddy_start_instance(instance_id: String) -> Result<InstanceProfileView, String> {
    codebuddy_call_async("instance.start", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn codebuddy_stop_instance(instance_id: String) -> Result<InstanceProfileView, String> {
    codebuddy_call_async("instance.stop", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn codebuddy_open_instance_window(instance_id: String) -> Result<(), String> {
    codebuddy_call("instance.openWindow", json!({ "instanceId": instance_id }))
}

#[tauri::command]
pub async fn codebuddy_close_all_instances() -> Result<(), String> {
    codebuddy_call_async("instance.closeAll", json!({})).await
}
