...
#[tauri::command]
pub async fn github_copilot_get_instance_defaults() -> Result<InstanceDefaults, String> {
    github_copilot_call_async("instance.getDefaults", json!({})).await
}

#[tauri::command]
pub async fn github_copilot_list_instances() -> Result<Vec<InstanceProfileView>, String> {
    github_copilot_call_async("instance.list", json!({})).await
}
...
pub async fn github_copilot_delete_instance(instance_id: String) -> Result<(), String> {
    github_copilot_call_async("instance.delete", json!({ "instanceId": instance_id })).await
}
...
pub async fn github_copilot_start_instance(
    ...
    github_copilot_call_async("instance.start", json!({ "instanceId": instance_id })).await
}
...
pub async fn github_copilot_stop_instance(
    ...
    github_copilot_call_async("instance.stop", json!({ "instanceId": instance_id })).await
}

#[tauri::command]
pub async fn github_copilot_open_instance_window(instance_id: String) -> Result<(), String> {
    github_copilot_call("instance.openWindow", json!({ "instanceId": instance_id }))
}

#[tauri::command]
pub async fn github_copilot_close_all_instances() -> Result<(), String> {
    github_copilot_call_async("instance.closeAll", json!({})).await
}
