...
export type GeminiAccountsContentTab = "overview" | "instances";

interface GeminiAccountsContentProps {
...
export function GeminiAccountsContent({ activeTab }: GeminiAccountsContentProps) {
