...
export type KiroAccountsContentTab = 'overview' | 'instances';

interface KiroAccountsContentProps {
  activeTab: KiroAccountsContentTab;
}

export function KiroAccountsContent({ activeTab }: KiroAccountsContentProps) {
  ...
  return (
    <div className="ghcp-accounts-page kiro-accounts-page kiro-platform-ui-root">
        ...
        <div className="modal-overlay">
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={closeDeleteConfirm} aria-label={t('common.close', '关闭')}><X /></button>
            </div>
            <div className="modal-body">
            ...
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={closeDeleteConfirm}>{t('common.cancel')}</button>
      ...
      {tagDeleteConfirm && (
        <div className="modal-overlay">
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>{t('common.confirm')}</h2>
              <button className="modal-close" onClick={closeTagDeleteConfirm} aria-label={t('common.close', '关闭')}><X /></button>
            </div>
            <div className="modal-body">
            ...
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={closeTagDeleteConfirm}>{t('common.cancel')}</button>
