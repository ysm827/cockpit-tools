...
export type CursorAccountsContentTab = 'overview' | 'instances';

interface CursorAccountsContentProps {
  activeTab: CursorAccountsContentTab;
}

export function CursorAccountsContent({ activeTab }: CursorAccountsContentProps) {
