...
export type CodebuddyAccountsContentTab = 'overview' | 'instances';

interface CodebuddyAccountsContentProps {
  activeTab: CodebuddyAccountsContentTab;
}

export function CodebuddyAccountsContent({ activeTab }: CodebuddyAccountsContentProps) {
        ...
        <div className="modal-overlay">
          <div className="modal confirm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => setDeleteConfirm(null)}>{t('common.cancel', '取消')}</button>
      ...
      {tagDeleteConfirm && (
        <div className="modal-overlay">
          <div className="modal confirm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => setTagDeleteConfirm(null)}>{t('common.cancel', '取消')}</button>
