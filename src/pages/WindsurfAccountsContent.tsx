...
export type WindsurfAccountsContentTab = 'overview' | 'instances';

interface WindsurfAccountsContentProps {
  activeTab: WindsurfAccountsContentTab;
}

export function WindsurfAccountsContent({
  activeTab,
}: WindsurfAccountsContentProps) {
    ...
    <div className="ghcp-accounts-page windsurf-accounts-page">
      ...
      {deleteConfirm && (
        <div className="modal-overlay"><div className="modal" onClick={(e) => e.stopPropagation()}>
          <div className="modal-header"><h2>{t('common.confirm')}</h2><button className="modal-close" onClick={closeDeleteConfirm} aria-label={t('common.close', '关闭')}><X /></button></div>
          ...
          <div className="modal-footer"><button className="btn btn-secondary" onClick={closeDeleteConfirm}>{t('common.cancel')}</button>
      ...
      {tagDeleteConfirm && (
        <div className="modal-overlay"><div className="modal" onClick={(e) => e.stopPropagation()}>
          <div className="modal-header"><h2>{t('common.confirm')}</h2><button className="modal-close" onClick={closeTagDeleteConfirm} aria-label={t('common.close', '关闭')}><X /></button></div>
          ...
          <div className="modal-footer"><button className="btn btn-secondary" onClick={closeTagDeleteConfirm}>{t('common.cancel')}</button>
